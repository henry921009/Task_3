...
class DirectQueryProcessor:
    ...
    def execute_query(self, query: str) -> List[dict]:
        ...
        try:
            ...
            logger.info(
                f"Query returned {len(results.get('results', {}).get('bindings', []))} results"
            )
...
def main():
    ...
    # 準備 CSV 檔案
    csv_file_path = "wikidata_results.csv"  # 修改為適合的路徑
    with open(csv_file_path, mode="w", newline="", encoding="utf-8") as file:
        writer = csv.writer(file)
        writer.writerow(["Question", "Method", "Execution Time (s)", "Answer"])
        ...
        for question in questions:
            ...
            try:
                ...
                if not entities_relations:
                    ...
                    writer.writerow([question, "Direct", "0.0000", "100"])
                    continue
                ...
                # 寫入 CSV
                writer.writerow([question, "Direct", f"{elapsed_time:.4f}", answer])
